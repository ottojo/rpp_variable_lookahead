...
#ifndef RPP_VARIABLE_LOOKAHEAD_CONTROLLER__PATH_HANDLER_HPP_
#define RPP_VARIABLE_LOOKAHEAD_CONTROLLER__PATH_HANDLER_HPP_
...
/**
 * @class rpp_variable_lookahead_controller::PathHandler
...
public:
  /**
   * @brief Constructor for rpp_variable_lookahead_controller::PathHandler
   */
  PathHandler(
  ...
  /**
   * @brief Destrructor for rpp_variable_lookahead_controller::PathHandler
   */
  ~PathHandler() = default;
...
#endif  // RPP_VARIABLE_LOOKAHEAD_CONTROLLER__PATH_HANDLER_HPP_
